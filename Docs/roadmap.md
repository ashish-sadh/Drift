...
- **AI Chat depth — GLP-1 tracking, test fixes & feedback loop (P0, cycle 8666 sprint)** — GLP-1 medication tracking: log_medication tool + DailyMedication model + medication card (#580). Fix testPortionScaling_DecimalServings (#568). Fix testRouterPrompt_TokenCeiling (#569). Settings → Feedback row (#329). State.md refresh to build 200 (#581). Planning crash fix (#407). Per-stage elapsed indicator (#309). PhotoLog BYOK onboarding tip (#331). Food DB: Indian protein staples (#413), American fast food (#414), Korean home cooking (#320), Mexican home cooking (#398). Voice biomarker repair +10 (#321).
