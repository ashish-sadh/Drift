...
- **Surface-and-discipline sprint (P0, cycle 9792/9794)** — Backup surface (#679) + E2E dogfood (#708) — close multi-sprint thread. qa-tester verdict audit (#722). Active crash hunt cycle 9794 (#723). Senior queue diversification — non-backup SENIOR task (#730). Cycle 9792 quality floor: State.md refresh build 239 (#724), failing-queries 9760→9792 (#725), FoodLoggingGoldSet (#726), Food DB +30 Mediterranean (#727), dashboard insight card spacing audit (#728). Cycle 9794 additions: dashboard activation prompt for Settings→Feedback null-signal (#731), failing-queries 9792→9794 (#732), FoodLoggingGoldSet (#733), State.md refresh build 240 (#734), LLM prompt quality audit (#735), `sleep_food_correlation` analytical tool (#736), MultiTurnRegression +8 cases (#737), Food DB +30 East Asian home cooking (#738), `cross_domain_pattern_detector` analytical tool — proactive cross-domain insights (#739), ChatPathSmokeTests +3 proactive-coaching paths (#740). Bug: GLP1InsightToolTests date-flake (#729).
