...
## Numbers
- **Version:** 0.1.0, Build 203
- **Tests:** ~1219 iOS DriftTests + 1167 macOS DriftCoreTests (cross-platform pure-logic suite, ~8s); LLM eval ~160+ cases in DriftLLMEvalMacOS
...
Post-DriftCore extraction (Apr 25, 2026, build 174; updated build 203):
